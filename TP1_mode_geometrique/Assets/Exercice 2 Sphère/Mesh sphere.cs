...
public class Mesh_Sphere : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        meshObject = new GameObject("Mesh Object Sphere", typeof(MeshRenderer), typeof(MeshFilter));
    ...
    private void GenerateSphereData()
    {
        ...
        for (int i = 1; i <= nombre_Paralleles; i++)
        {
            float phi = i * phiStep;
